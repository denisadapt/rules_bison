...
BISON_VERSION_TO_GNULIB_URLS = {
    ...
    "3.3.2": {
        "urls": ["https://github.com/jmillikin/rules_bison/releases/download/v0.1/bison-gnulib-788db09a9f88abbef73c97e8d7291c40455336d8.tar.xz"],
        "sha256": "4350696d531852118f3735a0e2d1091746388392c27d582f0cc241b6a39fe493",
...
def gnulib_overlay(ctx, bison_version, extra_copts = []):
    source = BISON_VERSION_TO_GNULIB_URLS[bison_version]
